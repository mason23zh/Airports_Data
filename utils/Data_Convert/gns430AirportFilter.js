...
module.exports.filterOutGlobalAirportsUsingGNS430_data = async () => {
    const globalAirportData = JSON.parse(fs.readFileSync(global_airport_data_with_location, "utf8"));
    ...
    fs.writeFileSync("./dev-data/GNS430_data/GNS430_airports_with_location.json", filteredAirport_json);
